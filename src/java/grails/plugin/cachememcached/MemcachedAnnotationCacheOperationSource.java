...
/**
 * @author : prostohz
 * @since : 2/25/13 6:12 PM
 */
public class MemcachedAnnotationCacheOperationSource implements CacheOperationSource, Serializable {
     ...
     * Constructor.
     */
    public MemcachedAnnotationCacheOperationSource() {
